...
const targetKind: Record<string, Kind> = { Pod: "pod", Deployment: "deploy", StatefulSet: "sts", DaemonSet: "ds", CronJob: "cron", Job: "job", PersistentVolumeClaim: "pvc", HorizontalPodAutoscaler: "hpa", ConfigMap: "cm", Secret: "secret" };
