...
import { ForwardService, RouteService } from "@bindings/internal/bindings";
import { router } from "@/router";
import { useUIStore } from "@/store";
import "@/index.css";

const queryClient = new QueryClient();
const { setRouteStatus, setForwardStatus, addHostKeyPrompt, removeHostKeyPrompt } = useUIStore.getState();
